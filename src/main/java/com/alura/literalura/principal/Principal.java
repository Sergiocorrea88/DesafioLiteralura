...
public class Principal {
            ...
            switch (opcion) {
                case 1:
                    ...
                    try {
                        ...
                        System.out.println("Ocurrió un error al procesar la solicitud: " + e.getMessage());
                    }
                    break;
                case 2:
                    libroService.listarLibros().forEach(libro -> {
                        ...
                        System.out.println("Autor: " + (libro.getAutor() != null ? libro.getAutor().getNombre() : "Desconocido")); // He añadido manejo de null
                ...
                case 3:
                    autorService.listarAutores().forEach(autor -> {
                        ...
                        System.out.println("Fecha de fallecimiento: " + (autor.getAnoFallecimiento() != null ? autor.getAnoFallecimiento() : "Desconocida")); // He añadido manejo de null
                ...
                case 4:
                    ...
                    if (autoresVivos.isEmpty()) {
                        ...
                        autoresVivos.forEach(autor -> {
                            ...
                            System.out.println("Autor: " + autor.getNombre());
                            System.out.println("Fecha de nacimiento: " + autor.getAnoNacimiento());
                            System.out.println("Fecha de fallecimiento: " + (autor.getAnoFallecimiento() != null ? autor.getAnoFallecimiento() : "Desconocida")); // Manejo de null
                ...
                case 5:
                    ...
                    if ("es".equalsIgnoreCase(idioma) || "en".equalsIgnoreCase(idioma) || "fr".equalsIgnoreCase(idioma) || "pt".equalsIgnoreCase(idioma)) {
                        libroService.listarLibrosPorIdioma(idioma).forEach(libro -> {
                            System.out.println("------LIBRO------");
                            System.out.println("Titulo: " + libro.getTitulo());
                            System.out.println("Autor: " + (libro.getAutor() != null ? libro.getAutor().getNombre() : "Desconocido")); // Manejo de null
                            System.out.println("Idioma: " + libro.getIdioma());
                            System.out.println("Número de descargas: " + libro.getNumeroDescargas());
                        });
                    } else {
    ...
    private void mostrarDetallesLibro(LibroDTO libroDTO) {
        ...
        System.out.println("Autor: " + (libroDTO.getAutores().isEmpty() ? "Desconocido" : libroDTO.getAutores().get(0).getNombre())); // Manejo de lista vacía y acceso al nombre
